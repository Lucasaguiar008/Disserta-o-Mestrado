...
% waypoints
WayPoints = [2,9;3,4;5,9;6,7;7,5;8,2;9,10;10,7;];
...
%Obstaculos
Obstaculos = [];
Obstaculos = [Obstaculos; criar_obstaculo(6,5,7,0.01)];
Obstaculos = [Obstaculos; criar_obstaculo(8,5,7,0.01)];
...
capacidadeMaxima = 100.*ones(Nv,1); % capacidade máxima da mochila
distMax = 100; % distância máxima percorrida
...
mutipleDWA_comRestricaoTempo(Nv,rotas,Obstaculos,"Resultado ACO+A*+DWA",numfig,gravar,nomeVideo,margem_seg_desvioObstaculos + distMax_voo,capacidadeMaxima,P_best,wp_visitados);
