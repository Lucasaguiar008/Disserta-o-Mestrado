...
% distMax = 20; % distância máxima percorrida (galpão 1 e 2)
distMax = 30; % distância máxima percorrida (galpão 1 e 2)
...
nomeResultado = ["Resultados_2024_tese\resultados_experimento3\Galpão_1\VANT_"+num2str(VANT)+"_exp_"+num2str(exp)+".mat"];
save(nomeResultado)

set(gcf, 'WindowState', 'maximized');

%Salvar a figura como um arquivo .fig
saveas(gcf,  ["Resultados_2024_tese\resultados_experimento3\Galpão_1\imagens\VANT_"+num2str(VANT)+"_exp_"+num2str(exp)+".fig"]);
